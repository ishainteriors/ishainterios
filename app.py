...
st.set_page_config(page_title="Isha Interiors AI", page_icon="🏠")

st.title("🏠 Isha Interiors — Marketing Generator")
st.write("Generate Instagram/Facebook posts and AI photo prompts for Hyderabad projects.")

# Enter Key
api_key = st.text_input("Enter Gemini API Key:", type="password")

# Input Form
project_type = st.selectbox("Project Type", ["3BHK Modern Apartment Interior", "2BHK Apartment Interior", "Luxury Villa Interior", "Modular Kitchen Renovation", "Commercial Office"])
locality = st.text_input("Locality in Hyderabad", value="Gachibowli")
target_budget = st.selectbox("Target Budget", ["Mid to Premium", "High-End Luxury", "Budget-Friendly"])
key_features = st.text_area("Key Design Features", value="Modular kitchen, false ceiling with cove lighting, space-saving wardrobes, warm wood finishes")
